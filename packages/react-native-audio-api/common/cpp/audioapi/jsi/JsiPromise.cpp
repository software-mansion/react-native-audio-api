...
jsi::Value PromiseVendor::createAsyncPromise(std::function<PromiseResolver()> &&function) {
  ...
  auto promiseLambda = [threadPool = std::move(threadPool),
                        ...
                        function = std::move(function)](jsi::Runtime &runtime,
    ...
    threadPool->schedule(&PromiseVendor::asyncPromiseJob,
...
void PromiseVendor::asyncPromiseJob(std::shared_ptr<react::CallInvoker> callInvoker,
  ...
  callInvoker->invokeAsync([resolver = std::move(resolver),
