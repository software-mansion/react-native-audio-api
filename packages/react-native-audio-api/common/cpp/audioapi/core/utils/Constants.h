...
static float LOG2_MOST_POSITIVE_SINGLE_FLOAT =
    std::log2(MOST_POSITIVE_SINGLE_FLOAT);
static float LOG10_MOST_POSITIVE_SINGLE_FLOAT =
    std::log10(MOST_POSITIVE_SINGLE_FLOAT);
static constexpr float PI = std::numbers::pi_v<float>;

// buffer sizes
static constexpr size_t PROMISE_VENDOR_THREAD_POOL_WORKER_COUNT = 4;
static constexpr size_t PROMISE_VENDOR_THREAD_POOL_LOAD_BALANCER_QUEUE_SIZE =
    32;
