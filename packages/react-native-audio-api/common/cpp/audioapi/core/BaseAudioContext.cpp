...
std::shared_ptr<AudioGraphManager> BaseAudioContext::getAudioGraphManager() const {
    return graphManager_;
}

std::shared_ptr<IAudioEventHandlerRegistry>
    BaseAudioContext::getAudioEventHandlerRegistry() const {
