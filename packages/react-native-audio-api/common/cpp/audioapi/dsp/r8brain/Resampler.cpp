...
MultiChannelResampler::MultiChannelResampler(double srcRate, double dstRate, int numChannels, int maxInLen) {
...
int MultiChannelResampler::process(const audioapi::AudioBuffer &input, int l, audioapi::AudioBuffer &output) {
...
int MultiChannelResampler::process(const std::vector<float*>& input, int l, std::vector<float*>& output) {
  int outLen = 0;
