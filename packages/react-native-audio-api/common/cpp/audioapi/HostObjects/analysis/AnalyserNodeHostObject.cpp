...
JSI_PROPERTY_GETTER_IMPL(AnalyserNodeHostObject, window) {
  ...
  return jsi::String::createFromUtf8(runtime, AnalyserNodeHostObject::windowTypeToString(windowType));
}
...
JSI_PROPERTY_SETTER_IMPL(AnalyserNodeHostObject, window) {
  ...
  analyserNode->setWindowType(AnalyserNodeHostObject::windowTypeFromString(type));
}
