...
TEST_F(AudioParamTest, NoEventsReturnsCurrentValue) {
  auto param = AudioParam(0.5, 0.0, 1.0, context);
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.0), 0.5f);
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 1.0), 0.5f);

  param.setValue(0.7f);
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.0), 0.7f);
}
...
TEST_F(AudioParamTest, SetValueAtTime) {
  ...
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.05), 0.5f);
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.1), 0.8f);
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.15), 0.8f);
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.2), 0.3f);
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.25), 0.3f);
}
...
TEST_F(AudioParamTest, LinearRampToValueAtTime) {
  ...
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.05), 0.25f);
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.1), 0.5f);
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.15), 0.75f);
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.2), 1.0f);
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.25), 1.0f);
}
...
TEST_F(AudioParamTest, ExponentialRampToValueAtTime) {
  ...
  EXPECT_NEAR(param.processKRateParam(1, 0.05), 0.17783f, 1e-5f);
  EXPECT_NEAR(param.processKRateParam(1, 0.1), 0.316228f, 1e-5f);
  EXPECT_NEAR(param.processKRateParam(1, 0.15), 0.562341f, 1e-5f);
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.2), 1.0f);
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.25), 1.0f);
}
...
TEST_F(AudioParamTest, SetTargetAtTime) {
  ...
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.05), 0.0f);
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.1), 0.0f);
  EXPECT_NEAR(param.processKRateParam(1, 0.15), 0.393469f, 1e-5f);
  EXPECT_NEAR(param.processKRateParam(1, 0.2), 0.632120f, 1e-5f);
  EXPECT_NEAR(param.processKRateParam(1, 0.25), 0.776869f, 1e-5f);
  EXPECT_NEAR(param.processKRateParam(1, 0.5), 0.981684f, 1e-5f);
}
...
TEST_F(AudioParamTest, LinearRampInsertedBetweenSetValueAtTimeEvents) {
  ...
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.05), 0.0f);
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.1), 0.2f);
  // midpoint: 0.2 + (0.6 - 0.2) * 0.5
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.15), 0.4f);
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.2), 0.6f);
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.25), 0.6f);
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.3), 0.8f);
}
...
TEST_F(AudioParamTest, ExponentialRampInsertedBetweenSetValueAtTimeEvents) {
  ...
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.0), 0.1f);
  EXPECT_NEAR(param.processKRateParam(1, 0.1), 0.1f * std::pow(10.0f, 0.5f), 1e-5f);
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.2), 1.0f);
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.3), 1.0f);
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.4), 0.8f);
}
...
TEST_F(AudioParamTest, SetValueAtTimeInsertedBeforeRampUpdatesRampChain) {
  ...
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.1), 0.0f);
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.2), 0.5f);
  // midpoint: 0.5 + (1.0 - 0.5) * 0.5
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.3), 0.75f);
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.4), 1.0f);
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.5), 1.0f);
}
...
TEST_F(AudioParamTest, SetValueAtTimeInsertedBetweenTwoRamps) {
  ...
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.1), 0.25f);
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.2), 0.3f);
  // midpoint of ramp2: 0.3 + (1.0 - 0.3) * 0.5
  EXPECT_NEAR(param.processKRateParam(1, 0.3), 0.65f, 1e-5f);
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.4), 1.0f);
}
...
TEST_F(AudioParamTest, SetValueAtTimeInsertedAfterSetTargetCapsIt) {
  ...
  EXPECT_NEAR(param.processKRateParam(1, 0.1), 1.0f - std::exp(-1.0f), 1e-5f);
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.2), 0.5f);
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.3), 0.5f);
}
...
TEST_F(AudioParamTest, CancelScheduledValues) {
  ...
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.2), 0.8f);
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.25), 0.8f);
}
...
TEST_F(AudioParamTest, CancelScheduledValuesBeforeAllEvents) {
  auto param = AudioParam(0.3, 0.0, 1.0, context);
  param.setValueAtTime(0.5, 0.1);
  param.setValueAtTime(0.8, 0.2);
  param.cancelScheduledValues(0.05);

  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.05), 0.3f);
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.1), 0.3f);
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.2), 0.3f);
}
...
TEST_F(AudioParamTest, CancelScheduledValuesAtCurveStart) {
  ...
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.2), 0.0f);
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.4), 0.0f);
}
...
TEST_F(AudioParamTest, CancelScheduledValuesWithinCurveRangeLeavesCurveIntact) {
  ...
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.0), 0.0f);
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.4), 1.0f);
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.6), 1.0f); // event gone — holds
}
...
TEST_F(AudioParamTest, CancelScheduledValuesAtSetTargetStart) {
  ...
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.1), 0.5f);
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.2), 0.5f);
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.5), 0.5f);
}
...
TEST_F(AudioParamTest, CancelScheduledValuesAfterSetTargetStartLeavesIt) {
  ...
  EXPECT_NEAR(param.processKRateParam(1, 0.3), 1.0f - std::exp(-3.0f), 1e-5f);
}
...
TEST_F(AudioParamTest, CancelAndHoldAtTimeWithNoEvents) {
  auto param = AudioParam(0.4, 0.0, 1.0, context);
  param.cancelAndHoldAtTime(0.5);

  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.5), 0.4f);
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 1.0), 0.4f);
}
...
TEST_F(AudioParamTest, CancelAndHoldAtTime) {
  ...
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.05), 0.0f);
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.1), 0.8f);
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.15), 0.9f);
  // Events after cancel time are removed -> stays at last value
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.2), 0.9f);
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.25), 0.9f);
}
...
TEST_F(AudioParamTest, CancelAndHoldAtTimeWithExponentialRamp) {
  ...
  EXPECT_NEAR(param.processKRateParam(1, 0.05), 0.1f * std::pow(10.0f, 0.25f), 1e-5f);
  EXPECT_NEAR(param.processKRateParam(1, 0.1), holdValue, 1e-5f);
  EXPECT_NEAR(param.processKRateParam(1, 0.3), holdValue, 1e-5f);
}
...
TEST_F(AudioParamTest, CancelAndHoldAtTimeWithSetTarget) {
  ...
  EXPECT_NEAR(param.processKRateParam(1, 0.05), 1.0f - std::exp(-0.5f), 1e-5f);
  EXPECT_NEAR(param.processKRateParam(1, 0.1), holdValue, 1e-5f);
  EXPECT_NEAR(param.processKRateParam(1, 0.2), holdValue, 1e-5f);
  EXPECT_NEAR(param.processKRateParam(1, 1.0), holdValue, 1e-5f);
}
...
TEST_F(AudioParamTest, CancelAndHoldAtTimeWithCurrentEventSetTarget) {
  ...
  EXPECT_NEAR(param.processKRateParam(1, 0.2), holdValue, 1e-5f);
  EXPECT_NEAR(param.processKRateParam(1, 0.5), holdValue, 1e-5f);
}
...
TEST_F(AudioParamTest, CancelAndHoldAtTimeWithSetValueCurveAfterRange) {
  ...
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.2), 1.0f);
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.3), 1.0f);
  EXPECT_FLOAT_EQ(param.processKRateParam(1, 0.4), 1.0f); // event gone — holds
}
