...
Pod::Spec.new do |s|
  ...
  s.subspec 'KFR' do |kfr|
    kfr.source_files       = "external/kfr/src/**/*.{cpp}"
    kfr.public_header_files = "external/kfr/include/kfr/**/*.{h,hpp}"
    kfr.xcconfig = {
      'HEADER_SEARCH_PATHS' => '"$(PODS_TARGET_SRCROOT)/external/kfr/include"',
