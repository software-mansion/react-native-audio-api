...
<details>
<summary>Example decoding using react native Image component <MobileOnly/> </summary>

:::caution
React Native by default only support .mp3, .wav, .mp4, .m4a, .aac audio file formats.
...
const uri = Image.resolveAssetSource(require('path/to/file')).uri;
