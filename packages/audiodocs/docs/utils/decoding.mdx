...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td align="center">[`ArrayBuffer`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/ArrayBuffer) with audio data.</td>
    </tr>
    <tr>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td align="center">Encoded audio bytes (mobile only).</td>
    </tr>
    <tr>
      <td align="center"><code>string</code></td>
      <td align="center">Local path, <code>file://</code> URI, or remote URL.</td>
    </tr>
    <tr>
      <td align="center"><code>fetchOptions</code><Optional /></td>
      <td align="center"><code>[RequestInit](https://github.com/facebook/react-native/blob/ac06f3bdc76a9fd7c65ab899e82bff5cad9b94b6/packages/react-native/src/types/globals.d.ts#L265)</code></td>
      <td align="center">Additional fetch options when <code>input</code> is a remote URL (for example, auth headers).</td>
    </tr>
  </tbody>
</table>
