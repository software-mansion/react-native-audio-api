...
This node is not part of [`react-native-audio-worklets`](https://www.npmjs.com/package/react-native-audio-worklets) yet. The documentation below describes the planned API. For now, use [`WorkletNode`](/docs/worklets/worklet-node).
:::
...
For more information about worklets, see the [Worklets introduction](/docs/worklets/introduction).
...
:::note
This constructor is not available yet. It will ship in a future release of `react-native-audio-worklets`.
:::
