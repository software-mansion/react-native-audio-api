...
:::warning
This node is dependent on `react-native-worklets` and you need to install them in order to use this node. Refer to [getting-started page](/docs/fundamentals/getting-started#additional-dependencies) for more info.
:::
