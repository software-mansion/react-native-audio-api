...
import BiquadExampleSrc from '!!raw-loader!@site/src/examples/Biquad/BiquadExampleSource';

<InteractiveExample src={BiquadExampleSrc} component={BiquadExample} />
...
import FrequencyResponseGraph from '@site/src/examples/Biquad/FrequencyResponseGraphComponent';
import FrequencyResponseGraphSrc from '!!raw-loader!@site/src/examples/Biquad/FrequencyResponseGraphSource';

<InteractiveExample src={FrequencyResponseGraphSrc} component={FrequencyResponseGraph} />
...
## Remarks
TODO: https://developer.mozilla.org/en-US/docs/Web/API/BiquadFilterNode#instance_properties
#### `frequency`
