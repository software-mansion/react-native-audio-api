...
| :---: | :---: | :----: | :---- |
| `Q` <Optional /> | `number` | `1.0` | Initial value for [`Q`](/docs/effects/biquad-filter-node#properties) |
| `detune` <Optional /> | `number` | `0.0` | Initial value for [`detune`](/docs/effects/biquad-filter-node#properties) |
| `frequency` <Optional /> | `number` | `350.0` | Initial value for [`frequency`](/docs/effects/biquad-filter-node#properties) |
| `gain` <Optional /> | `number` | `0.0` | Initial value for [`gain`](/docs/effects/biquad-filter-node#properties) |
