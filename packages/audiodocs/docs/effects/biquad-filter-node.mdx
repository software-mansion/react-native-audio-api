...
import Biquad from '@site/src/examples/Biquad/Component';
import BiquadSrc from '!!raw-loader!@site/src/examples/Biquad/Source';

<InteractiveExample src={BiquadSrc} component={Biquad} />
