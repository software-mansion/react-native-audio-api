...
| :---: | :---: | :----: | :---- |
| `maxDelayTime` <Optional /> | `number` | 1 | Maximum amount of time, in seconds, to buffer delayed values. |
| `delayTime` <Optional /> | `number` | 0 | Initial value for [`delayTime`](/docs/effects/delay-node#properties). |
