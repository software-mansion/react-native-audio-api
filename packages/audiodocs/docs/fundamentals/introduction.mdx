...
- following standard of web audio
- performance, flexibility and synchronization
- bringing tools built on top of web audio to react-native world


## How it works

**Making the web audio cross-platform**:
