...
React Native Audio API is an imperative, high-level API for processing and synthesizing audio in React Native Applications. It follows the [Web Audio Specification](https://www.w3.org/TR/webaudio-1.1/), making it easier to write audio-heavy applications for iOS, Android and Web with just one codebase.
...
- Truly native, we use most up-to-date native APIs such as [AVFoundation](https://developer.apple.com/documentation/avfoundation), [CoreAudio](https://developer.apple.com/documentation/coreaudio), or [Oboe](https://google.github.io/oboe/)
