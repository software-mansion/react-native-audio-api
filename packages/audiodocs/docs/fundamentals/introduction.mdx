...
Although when it comes to synchronization, applying effects or visualization of the audio, currently there are no alternatives to react-native-audio-api (other than writing in native yourself).
