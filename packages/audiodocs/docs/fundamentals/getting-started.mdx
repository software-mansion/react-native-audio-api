...
To use [`WorkletNode`](/docs/worklets/worklet-node), install [`react-native-audio-worklets`](https://www.npmjs.com/package/react-native-audio-worklets) and [`react-native-worklets`](https://www.npmjs.com/package/react-native-worklets) **>= 0.8.0**. See the [Worklets introduction](/docs/worklets/introduction) for the full setup guide.
