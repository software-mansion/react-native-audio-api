...
| `minDecibels` <Optional /> | `number` | `-100.0` | Initial minimum power in dB for FFT analysis |
| `maxDecibels` <Optional /> | `number` | `-30.0` | Initial maximum power in dB for FFT analysis |
