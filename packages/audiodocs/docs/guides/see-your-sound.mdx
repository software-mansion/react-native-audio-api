...
In this guide, we have learned how to extract audio data using [`AnalyserNode`](/visualization/analyser-node), what types of data we can obtain and how to visualize them. To sum up:
