...
Allows to get modifiable array with PCM data from given channel.
...
Allows to copy data from given channel of the `AudioBuffer` to an array.
...
Allows to copy data from given array to specified channel of the `AudioBuffer`.
