...
The above method to get modifiable array with PCM data from given channel.
...
The above method to copy data from given channel of the `AudioBuffer` to an array.
...
The above method to copy data from given array to specified channel of the `AudioBuffer`.
