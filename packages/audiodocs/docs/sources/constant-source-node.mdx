...
import SimplifiedOscillator from '@site/src/components/InteractivePlayground/ConstantSourceExample/ConstantSourceExample'
...
Similar to all of `AudioScheduledSourceNodes`, it can be started only once.
...
| :----: | :----: | :-------- | :------- |
| `offset` <ReadOnly /> | [`AudioParam`](/docs/core/audio-param) | 1 |[`a-rate`](/docs/core/audio-param#a-rate-vs-k-rate) `AudioParam` representing the value which the node constantly outputs. |
