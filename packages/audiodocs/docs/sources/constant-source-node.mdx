...
| :---: | :---: | :----: | :---- |
| `offset` <Optional /> | `number` | `1.0` | Initial value for [`offset`](/docs/sources/constant-source-node#properties) |

:::info
You can also create a `ConstantSourceNode` via [`BaseAudioContext.createConstantSource()`](/docs/core/base-audio-context#createconstantsource), that creates node with default values.
:::
