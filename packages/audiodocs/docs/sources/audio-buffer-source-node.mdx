...
`AudioBufferSourceNode(context: BaseAudioContext, options?: AudioBufferSourceOptions)`
...
Inherits all properties from [`BaseAudioBufferSourceOptions`](#baseaudiobuffersourceoptions).
