...
Allows user to set a worklet callback after every portion of data deliverance. You can read more about how react-native-audio-api supports worklets [here](/docs/other/worklets-support).
