...
It inherits all properties from [`BaseAudioContext`](/docs/core/base-audio-context).

## Methods

It inherits all methods from [`BaseAudioContext`](/docs/core/base-audio-context).
