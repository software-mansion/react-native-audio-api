...
Allows to create [`AnalyserNode`](/docs/analysis/analyser-node).

#### Returns `AnalyserNode`.

### `createRecorderAdapter`

Allows to create [`RecorderAdapterNode`](/docs/sources/recorder-adapter-node).

#### Returns `RecorderAdapterNode`

### `createBuffer`

Allows to create [`AudioBuffer`](/docs/sources/audio-buffer).
...
Allows to create [`AudioBufferSourceNode`](/docs/sources/audio-buffer-source-node).
...
Allows to create [`AudioBufferQueueSourceNode`](/docs/sources/audio-buffer-queue-source-node).
...
Allows to create [`GainNode`](/docs/effects/gain-node).

#### Returns `GainNode`.

### `createOscillator`

Allows to create [`OscillatorNode`](/docs/sources/oscillator-node).

#### Returns `OscillatorNode`.

### `createStreamer` <MobileOnly />

Allows to create [`StreamerNode`](/docs/sources/streamer-node).

#### Returns `StreamerNode`.

### `createPeriodicWave`

Allows to create [`PeriodicWave`](/docs/effects/periodic-wave). This waveform specifies a repeating pattern that an OscillatorNode can use to generate its output sound.
...
Allows to create [`StereoPannerNode`](/docs/effects/stereo-panner-node).

#### Returns `StereoPannerNode`.

### `createBiquadFilter`

Allows to create [`BiquadFilterNode`](/docs/effects/biquad-filter-node).
...
Allows to decode audio data. It decodes with in memory audio data block.
...
Allows to decode audio data file.
...
Allows to decode audio data. It decodes with PCM data in Base64.
