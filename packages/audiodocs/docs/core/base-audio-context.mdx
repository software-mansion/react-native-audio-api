...
| Type | Description |
| :---: | :---- |
| [`AudioBufferBaseSourceNodeOptions`](/docs/sources/audio-buffer-source-node#constructor) <Optional /> | Dictionary object that specifies if pitch correction has to be available. |
...
| Type | Description |
| :---: | :---- |
| [`AudioBufferBaseSourceNodeOptions`](/docs/sources/audio-buffer-queue-source-node#constructor) <Optional /> | Dictionary object that specifies if pitch correction has to be available. |
...
| Type | Description |
| :---: | :---- |
| [`ConvolverNodeOptions`](/docs/effects/convolver-node#constructor) <Optional /> | Dictionary object that specifies associated buffer and normalization. |
