...
| `runtimeKind` | `RuntimeKind` | The kind of runtime to use for the worklet. |

#### RuntimeKind values

| Name | Description |
| :---: | :---- |
| `UiRuntime` | The worklet will be executed in the UI thread. |
| `AudioRuntime` | The worklet will be executed in the audio rendering thread. |
