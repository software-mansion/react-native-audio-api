...
Allows to schedule an instant change to the `value` at given `startTime`.
...
Allows to schedule a gradual linear change to the new value.
...
Allows to schedule a gradual exponential change to the new value.
...
Allows to schedule a gradual change to the new value at the start time.
...
Allows to schedule the parameters's value change following a curve defined by given array.
...
Allows to cancel all scheduled changes after given cancel time.
...
Allows to cancel all scheduled changes after given cancel time, but holds its value at given cancel time until further changes appear.
