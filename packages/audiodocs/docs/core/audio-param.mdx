...
The above method to schedule an instant change to the `value` at given `startTime`.
...
The above method to schedule a gradual linear change to the new value.
...
The above method to schedule a gradual exponential change to the new value.
...
The above method to schedule a gradual change to the new value at the start time.
...
The above method to schedule the parameters's value change following a curve defined by given array.
...
The above method to cancel all scheduled changes after given cancel time.
...
The above method to cancel all scheduled changes after given cancel time, but holds its value at given cancel time until further changes appear.
