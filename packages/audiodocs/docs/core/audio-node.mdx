...
There are three properties involved in mixing process: `channelCount`, [`ChannelCountMode`](../types/channel-count-mode.mdx), [`ChannelInterpretation`](../types/channel-interpretation.mdx).
...
| :----: | :----: | :-------- | :-: |
| `context` | [`BaseAudioContext`](./base-audio-context.mdx) | Associated context. | <ReadOnly /> |
...
| `channelCountMode` | [`ChannelCountMode`](../types/channel-count-mode.mdx) | Enumerated value that specifies the method by which channels are mixed between the node's inputs and outputs. | <ReadOnly /> |
| `channelInterpretation` | [`ChannelInterpretation`](../types/channel-interpretation.mdx) | Enumerated value that specifies how input channels are mapped to output channels when number of them is different. | <ReadOnly /> |
...
| :---: | :---: | :---- |
| `destination` | [`AudioNode`](./audio-node.mdx) or [`AudioParam`](./audio-param.mdx) | `AudioNode` or `AudioParam` to which to connect. |
...
| Parameter | Type | Description |
| :---: | :---: | :---- |
| `destination` <Optional /> | [`AudioNode`](./audio-node.mdx) or [`AudioParam`](./audio-param.mdx) | `AudioNode` or `AudioParam` from which to disconnect. |
...
| `channelCountMode` <Optional /> | [`ChannelCountMode`](../types/channel-count-mode.mdx) | `max` | Determines how the number of input channels affects the number of output channels in an audio node. |
| `channelInterpretation` <Optional /> | [`ChannelInterpretation`](../types/channel-interpretation.mdx) | `speakers` | Specifies how input channels are mapped out to output channels when the number of them are different. |
