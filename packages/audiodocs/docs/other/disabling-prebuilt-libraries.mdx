...
| :---: | :---- | :---- |
| `disableFFmpeg` | FFmpeg shared libraries (`libavcodec`, `libavformat`, `libavutil`, `libswresample`) | Remote URL streaming / HLS, remote URL metadata, M4A concat, **Android** non-WAV recording — see [Runtime flags](./runtime-flags.mdx#where-ffmpeg-is-used) |
...
<Tabs queryString="platform">
  <TabItem value="expo" label="Expo" default>
    Add an entry in the [Audio API Expo plugin](./audio-api-plugin.mdx) configuration:
