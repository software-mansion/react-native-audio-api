...
`react-native-worklets` library set up with version <u>0.7.0</u> or higher. See [worklets getting-started page](https://docs.swmansion.com/react-native-worklets/docs/) for info how to do it.
