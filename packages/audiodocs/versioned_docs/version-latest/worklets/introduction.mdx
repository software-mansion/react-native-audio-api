...
```
> **Note**: Supported versions of `react-native-worklets` are 0.7.0 and higher. They are checked and updated manually with each release. Nightly versions are always supported but your build may fail.
