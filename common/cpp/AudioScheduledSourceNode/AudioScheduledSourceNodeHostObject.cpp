...
namespace audioapi {
    ...
    std::shared_ptr<AudioScheduledSourceNodeWrapper> AudioScheduledSourceNodeHostObject::
    ...
    std::vector<jsi::PropNameID> AudioScheduledSourceNodeHostObject::getPropertyNames(
            jsi::Runtime &runtime) {
        ...
        if (propName == "start") {
            return jsi::Function::createFromHostFunction(
                    ...
                    [this](
                        ...
                        auto wrapper = getAudioScheduledSourceNodeWrapperFromAudioNodeWrapper();
                        wrapper->start(time);
