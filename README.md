...
The source code for the example app is unther the [`/apps/CommonExample`](./apps/CommonExample/) directory. Check [Example README](./apps/CommonExample/README.md) file for installation instruction.
