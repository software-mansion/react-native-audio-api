...
| `common/cpp/test/RunCoverage.sh` | Coverage build dir, llvm-profdata/llvm-cov report+HTML, ignore regexes |
| `.clang-format-ignore` / `scripts/cpplint.sh` | Generated-directory exclusions — both must keep matching the `build*` prefix |
